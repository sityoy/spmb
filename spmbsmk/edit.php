...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (($nilai_test < 0 && $nilai_test != 0) || $nilai_test > 100) {
        ...
        // Update semua data ke database (termasuk catatan_panitia & KJP)
        $update = mysqli_query($conn, "UPDATE pendaftar SET 
            ...
            status_kjp = '$status_kjp',
            no_rek_kjp = '$no_rek_kjp',
            nilai_skl = '$nilai_skl', 
            nilai_tka = '$nilai_tka', 
    ...
    <form action="" method="POST" enctype="multipart/form-data">
        ...
        <div class="grid-layout">
            <div>
                ...
                <div class="form-group">
                    <label>No. Rekening KJP (Bila Punya KJP)</label>
                    <input type="text" name="no_rek_kjp" value="<?php echo htmlspecialchars($data['no_rek_kjp'] ?? '', ENT_QUOTES, 'UTF-8'); ?>">
                </div>
            ...
            <div>
                ...
                <div class="form-group file-box">
                    <label>File Tabungan KJP (Khusus KJP)</label>
                    <?php if(!empty($data['file_tabungan_kjp'])): ?>
                        <span style="font-size:12px;">Status: ✅ Ada</span> 
                        <a href="view_file.php?file=<?php echo urlencode($data['file_tabungan_kjp']); ?>" target="_blank" class="btn-lihat">👁️ Pratinjau File Lama</a>
                    <?php else: ?>
                        <span style="font-size:12px; color:#dc2626;">Status: ❌ Belum ada</span>
                    <?php endif; ?>
